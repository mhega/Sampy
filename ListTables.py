...
def titledashes(header):
    # How amazing Python is that we are converting a tuple of header data to a tuple of separator dashes of the same length in one line.
    # e.g., Converting ('Session','User') to ('-------','----')
